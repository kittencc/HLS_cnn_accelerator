...
##############################################################################
#
# Solution: InputDoubleBuffer<4096,16,16>.v1
#
# Catapult Ultra Synthesis 10.4b/841621 (Production Release) Thu Oct 24 17:20:07 PDT 2019
#
solution new -state initial -version v1 InputDoubleBuffer<4096,16,16>
...
##############################################################################
#
# Solution: WeightDoubleBuffer<4096,16,16>.v1
#
# Catapult Ultra Synthesis 10.4b/841621 (Production Release) Thu Oct 24 17:20:07 PDT 2019
#
solution new -state initial -version v1 WeightDoubleBuffer<4096,16,16>
solution options defaults
solution options set /Architectural/DefaultRegisterThreshold 4096
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath ./src
...
##############################################################################
#
# Solution: ProcessingElement<IDTYPE,WDTYPE,ODTYPE>.v1
#
# Catapult Ultra Synthesis 10.4b/841621 (Production Release) Thu Oct 24 17:20:07 PDT 2019
#
solution new -state initial -version v1 ProcessingElement<IDTYPE,WDTYPE,ODTYPE>
solution options defaults
solution options set /Architectural/DefaultRegisterThreshold 4096
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath ./src
...
##############################################################################
#
# Solution: SystolicArrayCore<IDTYPE,WDTYPE,ODTYPE,16,16>.v1
#
# Catapult Ultra Synthesis 10.4b/841621 (Production Release) Thu Oct 24 17:20:07 PDT 2019
#
solution new -state initial -version v1 SystolicArrayCore<IDTYPE,WDTYPE,ODTYPE,16,16>
solution options defaults
solution options set /Architectural/DefaultRegisterThreshold 4096
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath ./src
...
# Catapult Ultra Synthesis 10.4b/841621 (Production Release) Thu Oct 24 17:20:07 PDT 2019
#
solution new -state initial -version v1 Conv
solution options defaults
solution options set /Architectural/DefaultRegisterThreshold 4096
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath ./src
...
directive set /Conv/SystolicArrayWrapper<IDTYPE,WDTYPE,ODTYPE,16,16> -FIFO_DEPTH 3
go assembly
