...
#ifdef  CCS_DESIGN_FUNC_Conv_run
#define ccs_intercept_run_35 \
  run(ac_channel<ac_int<8, true > > &input_serial,ac_channel<ac_int<8, true > > &weight_serial,ac_channel<ac_int<16, true > > &output_serial,ac_channel<ac_int<16, false > > &paramsIn);\
  void ccs_real_run
#else
#define ccs_intercept_run_35 run
#endif //CCS_DESIGN_FUNC_Conv_run
