...
public:
  ...
  sc_in<sc_lv<8> > input_serial_rsc_dat;
  sc_in<sc_logic> input_serial_rsc_vld;
  sc_out<sc_logic> input_serial_rsc_rdy;
  sc_in<sc_lv<8> > weight_serial_rsc_dat;
  sc_in<sc_logic> weight_serial_rsc_vld;
  sc_out<sc_logic> weight_serial_rsc_rdy;
  sc_out<sc_lv<16> > output_serial_rsc_dat;
  sc_out<sc_logic> output_serial_rsc_vld;
  sc_in<sc_logic> output_serial_rsc_rdy;
  sc_in<sc_lv<16> > paramsIn_rsc_dat;
...
public:
  ...
  :
    ...
    clk("clk"), 
    arst_n("arst_n"), 
    input_serial_rsc_dat("input_serial_rsc_dat"), 
    input_serial_rsc_vld("input_serial_rsc_vld"), 
    input_serial_rsc_rdy("input_serial_rsc_rdy"), 
    weight_serial_rsc_dat("weight_serial_rsc_dat"), 
    weight_serial_rsc_vld("weight_serial_rsc_vld"), 
    weight_serial_rsc_rdy("weight_serial_rsc_rdy"), 
    output_serial_rsc_dat("output_serial_rsc_dat"), 
    output_serial_rsc_vld("output_serial_rsc_vld"), 
    output_serial_rsc_rdy("output_serial_rsc_rdy"), 
