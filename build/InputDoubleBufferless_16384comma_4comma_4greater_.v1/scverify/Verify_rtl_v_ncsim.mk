...
# Generated date: Sun Sep 18 20:11:42 PDT 2022
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/users/ctorng/work/cc/ee272-hw4/build/InputDoubleBufferless_16384comma_4comma_4greater_.v1
#   WORKING_DIR   /home/users/ctorng/work/cc/ee272-hw4/build/InputDoubleBufferless_16384comma_4comma_4greater_.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./build/InputDoubleBufferless_16384comma_4comma_4greater_.v1
PROJ2SOLN = ./build/InputDoubleBufferless_16384comma_4comma_4greater_.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/users/ctorng/work/cc/ee272-hw4/build/InputDoubleBufferless_16384comma_4comma_4greater_.v1/rtl.v
endif
...
export INVOKE_ARGS
export SCVLIBS
TOP_HDL_ENTITY           := InputDoubleBuffer_16384_4_4
TOP_DU                   := scverify_top
...
CXXFLAGS += -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_InputDoubleBuffer_16384_4_4_run -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/rtl.v.vts: DUT_E=InputDoubleBuffer_16384_4_4
