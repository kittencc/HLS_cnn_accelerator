...
class testbench
{
   ...
   static bool inputs_in_ignore;
   static bool inputs_in_skip;
   static bool inputs_in_skip_quiet;
   static bool inputs_in_skip_once;
   static bool inputs_in_skip_noerr;
   static int  inputs_in_array_comp_first;
   static int  inputs_in_array_comp_last;
   static mc_wait_ctrl inputs_in_wait_ctrl;
   static bool inputs_out_value_ignore;
   static bool inputs_out_value_skip;
   static bool inputs_out_value_skip_quiet;
   static bool inputs_out_value_skip_once;
   static bool inputs_out_value_skip_noerr;
   static int  inputs_out_value_array_comp_first;
   static int  inputs_out_value_array_comp_last;
   static bool inputs_out_value_use_mask;
   static ac_int<8, true > inputs_out_value_output_mask;
   static mc_wait_ctrl inputs_out_value_wait_ctrl;
...
extern void mc_testbench_inputs_in_skip(bool v);
extern void mc_testbench_inputs_out_value_skip(bool v);
