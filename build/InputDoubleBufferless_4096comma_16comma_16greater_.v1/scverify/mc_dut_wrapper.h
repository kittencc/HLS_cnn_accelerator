...
typedef
    ccs_design::HDL::InputDoubleBuffer<4096,16,16> ccs_DUT_wrapper;
...
public:
  ...
  sc_in<sc_lv<8> > inputs_in_rsc_dat;
  sc_in<sc_logic> inputs_in_rsc_vld;
  sc_out<sc_logic> inputs_in_rsc_rdy;
  sc_out<sc_lv<128> > inputs_out_rsc_dat;
  sc_out<sc_logic> inputs_out_rsc_vld;
  sc_in<sc_logic> inputs_out_rsc_rdy;
...
public:
  ...
  :
    ...
    inputs_out_rsc_dat("inputs_out_rsc_dat"), 
