...
// Generated date: Sat Oct 01 16:39:39 PDT 2022
//
// ----------------------------------------------------------------------------
#ifdef CCS_SCVERIFY
...
public:
   ...
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_int<8, true >,16> > > ccs_inputs_out_value;
   ...
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_int<8, true >,16>, ac_int<8, true > > > inputs_out_value_golden;
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_int<8, true >,16> , ac_int<8, true > > *inputs_out_value_comp;
      ...
      , remaining_ccs_paramsIn_STRIDE(0)
   {
      ...
      inputs_out_value_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_int<8, true >,16> , ac_int<8, true > > (
   ...
   public:
      void capture_inputs_out( ac_channel<PackedInt<8UL, 16UL > > &inputs_out) ;
   public:
      void capture_paramsIn( ac_channel<Params > &paramsIn) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN( ac_channel<ac_int<8, true > > &inputs_in,  ac_channel<PackedInt<8UL, 16UL > > &inputs_out,  ac_channel<Params > &paramsIn) ;
   public:
      static void capture_OUT( ac_channel<ac_int<8, true > > &inputs_in,  ac_channel<PackedInt<8UL, 16UL > > &inputs_out,  ac_channel<Params > &paramsIn) ;
   public:
      static void exec_run( ac_channel<ac_int<8, true > > &inputs_in,  ac_channel<PackedInt<8UL, 16UL > > &inputs_out,  ac_channel<Params > &paramsIn) ;
   protected:
