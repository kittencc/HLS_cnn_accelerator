...
typedef
    ccs_design::HDL::WeightDoubleBuffer<4096,16,16> ccs_DUT_wrapper;
...
public:
  ...
  sc_in<sc_lv<8> > weights_in_rsc_dat;
  sc_in<sc_logic> weights_in_rsc_vld;
  sc_out<sc_logic> weights_in_rsc_rdy;
  sc_out<sc_lv<128> > weights_out_rsc_dat;
  sc_out<sc_logic> weights_out_rsc_vld;
  sc_in<sc_logic> weights_out_rsc_rdy;
...
public:
  ...
  :
    ...
    weights_out_rsc_dat("weights_out_rsc_dat"), 
