...
go analyze
directive set -DESIGN_HIERARCHY {Conv {Serializer<PackedInt<16UL, 4UL>, ODTYPE, 4>} {SystolicArrayWrapper<IDTYPE, WDTYPE, ODTYPE, 4, 4>} SystolicArrayLooper {SystolicArrayCore<IDTYPE, WDTYPE, ODTYPE, 4, 4>} {Fifo<ODTYPE, 4>} {Fifo<ODTYPE, 3>} {Fifo<ODTYPE, 2>} {Fifo<ODTYPE, 1>} {Fifo<IDTYPE, 4>} {Fifo<IDTYPE, 3>} {Fifo<IDTYPE, 2>} {Fifo<IDTYPE, 1>} {ProcessingElement<IDTYPE, WDTYPE, ODTYPE>} {WeightDoubleBuffer<16384, 4, 4>} {WeightDoubleBufferReader<16384, 4, 4>} {WeightDoubleBufferWriter<16384, 4, 4>} {InputDoubleBuffer<16384, 4, 4>} {InputDoubleBufferReader<16384, 4, 4>} {InputDoubleBufferWriter<16384, 4, 4>} ParamsDeserializer}
go analyze
